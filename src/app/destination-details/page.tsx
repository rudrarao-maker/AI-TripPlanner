      ...
      <div className="container mx-auto max-w-6xl px-4 mt-16">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          ...
          <div className="flex gap-4 items-center">
            ...
            <Button variant="outline" className="rounded-full" onClick={() => router.push(`/trip-planner?dest=${encodeURIComponent(destination.name)}`)}>
              ...
              <Card className="glass-card h-full flex flex-col group overflow-hidden border-border/50">
                ...
                <CardContent className="p-5 flex flex-col flex-1">
                  ...
                  <Button 
                    ...
                    onClick={() => router.push(`/trip-planner?dest=${encodeURIComponent(destination.name)}&budget=${itinerary.amount}&style=${itinerary.travelStyle.toLowerCase()}&days=${parseInt(itinerary.duration)}`)}
                  >
