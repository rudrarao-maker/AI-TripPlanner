    ...
    async function fetchPlaces() {
      ...
      try {
        ...
        setPlaces([
          {
            place_id: "1",
            name: `Mock ${activeCategory} 1`,
            rating: 4.5,
            user_ratings_total: 120,
            vicinity: `Near ${locationName}`,
          },
          {
            place_id: "2",
            name: `Mock ${activeCategory} 2`,
            rating: 4.2,
          ...
          {
            place_id: "3",
            name: `Mock ${activeCategory} 3`,
            rating: 4.8,
            user_ratings_total: 300,
            vicinity: `North ${locationName}`,
          },
        ]);
      } finally {
        setIsLoading(false);
        ...
        <div className="space-y-3 mt-2 max-h-[300px] overflow-y-auto pr-1 custom-scrollbar">
          {isLoading ? (
            ...
            places.map((place) => (
              <div
                key={place.place_id}
                className="flex items-start justify-between p-3 rounded-xl border bg-card hover:bg-muted/30 transition-colors"
              >
                <div>
