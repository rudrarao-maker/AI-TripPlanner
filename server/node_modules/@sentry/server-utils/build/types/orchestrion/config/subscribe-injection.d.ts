 ...
 */
export declare const SUBSCRIBE_TRANSFORM_NAME = "sentrySubscribeOrchestrionChannel";
/**
 ...
 */
export declare function toSubscribeInjections(configs: InstrumentationConfig[]): InstrumentationConfig[];
//# sourceMappingURL=subscribe-injection.d.ts.map