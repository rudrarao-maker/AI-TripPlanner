...
export { amqplibChannelIntegration, anthropicChannelIntegration, awsChannelIntegration, dataloaderChannelIntegration, genericPoolChannelIntegration, googleGenAIChannelIntegration, graphqlChannelIntegration, hapiChannelIntegration, koaChannelIntegration, ioredisChannelIntegration, kafkajsChannelIntegration, knexChannelIntegration, langChainChannelIntegration, langGraphChannelIntegration, lruMemoizerChannelIntegration, mongodbChannelIntegration, mongooseChannelIntegration, mysqlChannelIntegration, mysql2ChannelIntegration, openaiChannelIntegration, postgresChannelIntegration, postgresJsChannelIntegration, tediousChannelIntegration, vercelAiChannelIntegration, expressChannelIntegration, firebaseChannelIntegration, };
export { KoaChannelIntegrationOptions } from '../integrations/tracing-channel/koa';
...
export { InstrumentationConfig, CustomTransform } from '@apm-js-collab/code-transformer-bundler-plugins/core';
...
export declare const channelIntegrations: {
    ...
    readonly mongoIntegration: () => import("@sentry/core").Integration & {
        name: "Mongo";
    };
    ...
    readonly mongooseIntegration: () => import("@sentry/core").Integration & {
        name: "Mongoose";
    };
    ...
    readonly langChainIntegration: (options?: import("@sentry/core").LangChainOptions | undefined) => import("@sentry/core").Integration & {
        name: "LangChain";
    };
    readonly langGraphIntegration: (options?: import("@sentry/core").LangGraphOptions | undefined) => import("@sentry/core").Integration & {
        name: "LangGraph";
    };
    readonly vercelAiIntegration: (options?: import("..").VercelAiOptions | undefined) => import("@sentry/core").Integration & {
        name: "VercelAI";
    };
    ...
    readonly koaIntegration: (options?: import(".").KoaChannelIntegrationOptions | undefined) => import("@sentry/core").Integration & {
        name: "Koa";
    };
    ...
    readonly tediousIntegration: () => import("@sentry/core").Integration & {
        name: "Tedious";
    };
    readonly awsIntegration: () => import("@sentry/core").Integration & {
        name: "Aws";
    };
    readonly firebaseIntegration: () => import("@sentry/core").Integration & {
        name: "Firebase";
    };
};
