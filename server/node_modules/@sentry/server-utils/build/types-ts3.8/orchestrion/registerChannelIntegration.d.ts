 ...
 * is idempotent.
 */
export declare function registerOrchestrionChannelIntegration(name: string, integrationFn: () => Integration): void;
//# sourceMappingURL=registerChannelIntegration.d.ts.map
