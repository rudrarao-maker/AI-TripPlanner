import { InstrumentationConfig, CustomTransform } from '..';
import { CodeTransformerPluginOptions } from '@apm-js-collab/code-transformer-bundler-plugins/core';
 ...
 */
export declare function externalEntryMatchesModule(entry: string, moduleName: string): boolean;
/**
 ...
 */
export declare function externalizedModulesWarning(externalizedModules: string[]): string;
/**
 ...
 */
export declare function orchestrionTransformOptions(options: PluginOptions): CodeTransformerPluginOptions;
