...
const mongodbSpan = require('../../mongodb/mongodb-span.js');
...
function subscribeV4Command() {
  tracingChannel.bindTracingChannelToSpan(
    diagnosticsChannel.tracingChannel(channels.CHANNELS.MONGODB_COMMAND),
    (data) => {
