...
import { NET_TRANSPORT, HTTP_FLAVOR, HTTP_SCHEME, HTTP_USER_AGENT, HTTP_CLIENT_IP, NET_HOST_NAME, HTTP_HOST, HTTP_TARGET, HTTP_METHOD, HTTP_URL, URL_PATH, URL_FULL, SENTRY_HTTP_PREFETCH, NET_HOST_IP, NET_HOST_PORT, NET_PEER_IP, NET_PEER_PORT, HTTP_STATUS_CODE, HTTP_ROUTE, HTTP_RESPONSE_STATUS_CODE } from '@sentry/conventions/attributes';
import { debug, parseStringToURLObject, stripUrlQueryAndFragment, startInactiveSpan, SPAN_KIND, httpHeadersToSpanAttributes, isURLObjectRelative, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN, SEMANTIC_ATTRIBUTE_SENTRY_OP, withActiveSpan, bindScopeToEmitter, getSpanStatusFromHttpCode, SPAN_STATUS_ERROR, isTracingSuppressed, getIsolationScope } from '@sentry/core';
        ...
        const startSpan = (next) => {
          ...
          const span = startInactiveSpan({
            ...
            attributes: {
              ...
              [URL_FULL]: urlObj && !isURLObjectRelative(urlObj) ? urlObj.href : void 0,
              ...
              [HTTP_CLIENT_IP]: typeof ips === "string" ? ips.split(",")[0] : void 0,
