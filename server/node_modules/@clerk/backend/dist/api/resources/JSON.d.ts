...
export declare const ObjectType: {
    ...
    readonly EnterpriseAccount: "enterprise_account";
    readonly EnterpriseConnection: "enterprise_connection";
    ...
    readonly Role: "role";
    readonly RoleSet: "role_set";
    readonly RoleSetItem: "role_set_item";
    readonly RoleSetMigration: "role_set_migration";
