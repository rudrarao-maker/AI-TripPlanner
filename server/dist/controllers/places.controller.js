...
const getNearbyPlaces = async (req, res) => {
    try {
        ...
        if (!lat || !lng) {
            return (0, response_1.sendError)(res, 400, "Latitude and longitude are required");
        }
        ...
        (0, response_1.sendSuccess)(res, 200, response.data.results);
    }
    catch (error) {
        console.error("[Places API] Failed to fetch nearby places:", error);
        (0, response_1.sendError)(res, 500, "Failed to fetch nearby places");
    }
};
