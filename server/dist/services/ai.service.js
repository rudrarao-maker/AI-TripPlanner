...
exports.getAlternativeActivities = exports.regenerateDay = exports.chatWithContext = exports.generateItinerary = exports.parseUserPrompt = void 0;
const genai_1 = require("@google/genai");
const client_1 = require("@prisma/client");
const destinations_1 = require("../data/destinations");
const ai = new genai_1.GoogleGenAI({ apiKey: process.env.GEMINI_API_KEY || "mock" });
...
function generateMockItinerary(tripDetails) {
    ...
    const legacyDestKey = Object.keys(destinations_1.DESTINATION_DATA).find((k) => dest.includes(k)) || "";
    const dData = destinations_1.DESTINATION_DATA[legacyDestKey];
    // Get hotel info
    ...
    return {
        ...
        days,
        coverImage: coverImages[destKey] ||
            dData?.coverImage ||
            "https://images.unsplash.com/photo-1476514525535-07fb3b4ae5f1?w=1200",
    };
}
const chatWithContext = async (message, context, chatHistory = []) => {
...
- Itinerary Days: ${context.tripDays
        ? JSON.stringify(context.tripDays.map((d, i) => ({
            day: i + 1,
...
function generateSmartMockResponse(message, context) {
...
// Day Regeneration
// ============================================================
const regenerateDay = async (tripId, dayNumber, preferences) => {
...
// ============================================================
const getAlternativeActivities = async (activityName, destination) => {
...
exports.getAlternativeActivities = getAlternativeActivities;
