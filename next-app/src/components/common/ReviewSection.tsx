...
const MOCK_REVIEWS: Review[] = [
  {
    ...
    date: "2 weeks ago",
    content:
      "Absolutely magical experience! The AI-planned itinerary was spot on — every restaurant recommendation was a hidden gem. Saved us hours of planning.",
    photos: [
      "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=200",
  ...
  },
  {
    ...
    date: "1 month ago",
    content:
      "Great tool for quick planning. The budget optimization feature helped us save nearly 20% on our Goa trip. Would love to see more international destinations.",
    helpful: 18,
  },
  {
    id: "r3",
    ...
    date: "3 weeks ago",
    content:
      "Used TripCraft for our honeymoon in Kerala. The day-by-day timeline was incredibly detailed and the hotel suggestions were dreamy. Highly recommended!",
    photos: [
      "https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=200",
    ],
    helpful: 31,
  },
  {
    ...
    date: "1 week ago",
    content:
      "The collaborative trip planning feature is a game changer. Our group of 6 could vote on activities and the AI adjusted the itinerary in real-time.",
    helpful: 15,
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg">
            Hear what fellow travelers are saying
          </p>
        </motion.div>
            ...
            <div className="text-center">
              ...
              <div className="flex gap-0.5 mt-1 justify-center">
                {[1, 2, 3, 4, 5].map((s) => (
                  <Star
                    key={s}
                    className={`h-5 w-5 ${s <= Math.round(averageRating) ? "fill-amber-400 text-amber-400" : "text-border"}`}
                  />
                ))}
              </div>
                ...
                <div>
                  ...
                  <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map((s) => (
                      ...
                      >
                        <Star
                          className={`h-8 w-8 transition-colors ${s <= (hoverRating || userRating) ? "fill-amber-400 text-amber-400" : "text-border"}`}
                        />
                      </button>
                    ))}
                  </div>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      >
                        <ThumbsUp
                          className={`h-3.5 w-3.5 ${review.isHelpful ? "fill-primary" : ""}`}
                        />
