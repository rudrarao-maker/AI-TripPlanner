    ...
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        <Route element={<MainLayout />}>
          ...
          <Route path="/itinerary/:id" element={<PageTransition><ItineraryDetailsPage /></PageTransition>} />
          <Route path="/plan" element={<PageTransition><TripPlannerPage /></PageTransition>} />
          <Route path="/flights" element={<PageTransition><FlightSearchPage /></PageTransition>} />
          <Route path="/hotels" element={<PageTransition><HotelSearchPage /></PageTransition>} />
          ...
          <Route path="/cookies" element={<PageTransition><LegalPage type="cookies" /></PageTransition>} />
          ...
          <Route path="/travel-guides" element={<PageTransition><TravelGuidesPage /></PageTransition>} />
          ...
          <Route element={<ProtectedRoute />}>
            ...
            <Route path="/expenses" element={<PageTransition><ExpenseTrackerPage /></PageTransition>} />
            <Route path="/journal" element={<PageTransition><TravelJournalPage /></PageTransition>} />
          ...
          <Route path="*" element={<PageTransition><PlaceholderPage title="404 - Page Not Found" /></PageTransition>} />
        </Route>
      </Routes>
    </AnimatePresence>
  );
