              ...
              <Card className="glass-card h-full flex flex-col group overflow-hidden border-border/50">
                ...
                <CardContent className="p-5 flex flex-col flex-1">
                  ...
                  <Button 
                    ...
                    onClick={() => navigate(`/plan?dest=${encodeURIComponent(destination.name)}&budget=${itinerary.amount}&style=${itinerary.travelStyle.toLowerCase()}&days=${parseInt(itinerary.duration)}`)}
                  >
