          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex gap-2">
              <input
                ...
                className="px-4 py-2 rounded-xl bg-muted border border-border/50 text-sm w-64 focus:outline-none focus:ring-2 focus:ring-primary/20"
              />
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        <div>
          ...
          <p className="text-muted-foreground">
            Manage users, content, analytics, and AI prompt templates.
          </p>
        </div>
      </div>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <Card className="glass">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
                  <TrendingUp className="h-5 w-5" /> Recent User Signups
                </CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className="glass">
              <CardHeader>
                <CardTitle className="flex items-center gap-2 text-lg">
                  <Building2 className="h-5 w-5" /> Pending Partner Approvals
                </CardTitle>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
