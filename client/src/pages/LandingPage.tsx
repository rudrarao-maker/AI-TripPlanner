...
import { FEATURED_DESTINATIONS, HOW_IT_WORKS } from "@/lib/constants";
...
export function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen relative overflow-hidden bg-transparent">
      ...
      {/* ============================================ */}
      {/* 1. HERO SECTION — Minimal & Centered */}
      {/* ============================================ */}
      ...
      {/* ============================================ */}
      {/* 2. HOW IT WORKS — Sleek Cards */}
      {/* ============================================ */}
      <section className="relative z-10 py-32 bg-background/40 backdrop-blur-3xl border-y border-white/5">
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="text-4xl font-bold tracking-tight mb-4">Intelligent Planning</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {HOW_IT_WORKS.map((item, i) => (
              <motion.div
                ...
                className="glass-card p-8 flex flex-col items-center text-center group hover:bg-white/5 transition-all duration-500"
              >
                <div className="w-16 h-16 rounded-2xl bg-primary/10 flex items-center justify-center text-3xl mb-6 text-primary group-hover:scale-110 transition-transform duration-500">
                  {item.icon}
                </div>
      ...
      {/* ============================================ */}
      {/* 3. POPULAR DESTINATIONS — Minimal Grid */}
      {/* ============================================ */}
      <section className="relative z-10 py-32 bg-transparent">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-16">
            <div>
              <h2 className="text-4xl font-bold tracking-tight mb-4">Curated Escapes</h2>
              <p className="text-muted-foreground text-lg font-light">
      ...
      <section className="relative z-10 py-32 mb-10 px-4">
        ...
        >
          ...
          <div className="relative z-10 max-w-2xl mx-auto space-y-8">
            ...
            >
              <Link to="/plan">
                Start Planning <ArrowRight className="h-5 w-5 ml-2" />
              </Link>
            </Button>
          </div>
        </motion.div>
