...
import { MapPin, Star, ArrowRight, ChevronRight, Clock, Wallet, Ticket, Compass, TrendingUp } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { Card, CardContent } from '@/components/ui/card';
import { HOW_IT_WORKS, STATS, FEATURED_DESTINATIONS, THINGS_TO_DO, TRENDING_SECTIONS, TESTIMONIALS } from '@/lib/constants';
    ...
    <div className="flex flex-col min-h-screen">
      ...
      <section className="relative pt-32 pb-16 md:pt-40 md:pb-24 flex flex-col justify-center overflow-hidden min-h-[90vh]">
        <div className="container relative z-10 mx-auto px-4 md:px-6 flex flex-col lg:flex-row items-center gap-12 lg:gap-8">
          ...
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left z-10">
            ...
            >
              ...
              <span className="italic font-normal bg-gradient-to-r from-primary to-accent bg-clip-text text-transparent">AI Magic.</span>
            </motion.h1>
            ...
            >
              Tell TripCraft's AI where you want to go. It builds your complete itinerary — hotels, restaurants, activities, and things to do — instantly. Invite your group, vote on the plan together, split the budget, and hit the road.
            </motion.p>
          ...
          >
            ...
            <div className="absolute top-0 right-1/2 translate-x-[20%] w-[260px] h-[360px] rounded-t-[130px] rounded-b-xl overflow-hidden shadow-2xl transition-transform hover:scale-105 duration-500">
              <img src="https://images.unsplash.com/photo-1516483638261-f4dafaa48cce?q=80&w=600" alt="Positano" className="w-full h-full object-cover" />
              <div className="absolute bottom-4 left-5 text-white text-lg font-bold italic drop-shadow-md font-heading">Positano</div>
            </div>
            ...
            <div className="absolute top-4 right-0 w-[300px] h-[160px] rounded-[30px] overflow-hidden shadow-2xl transition-transform hover:scale-105 duration-500 delay-100">
              <img src="https://images.unsplash.com/photo-1528127269322-539801943592?q=80&w=600" alt="Halong Bay" className="w-full h-full object-cover" />
              <div className="absolute bottom-3 left-5 text-white text-lg font-bold italic drop-shadow-md font-heading">Halong Bay</div>
            </div>
            ...
            <div className="absolute top-[180px] right-[10%] w-[240px] h-[140px] rounded-tl-[100px] rounded-br-[60px] rounded-tr-xl rounded-bl-xl overflow-hidden shadow-2xl transition-transform hover:scale-105 duration-500 delay-200">
              <img src="https://images.unsplash.com/photo-1503899036067-e13e8d75bab7?q=80&w=600" alt="Tokyo" className="w-full h-full object-cover" />
              <div className="absolute bottom-3 left-5 text-white text-lg font-bold italic drop-shadow-md font-heading">Tokyo</div>
            </div>
            ...
            <div className="absolute top-[380px] right-1/2 translate-x-[35%] w-[380px] h-[140px] rounded-2xl overflow-hidden shadow-2xl z-10 transition-transform hover:scale-105 duration-500 delay-300">
              <img src="https://images.unsplash.com/photo-1539020140153-e479b8c22e70?q=80&w=600" alt="Marrakech" className="w-full h-full object-cover" />
              <div className="absolute bottom-3 left-5 text-white text-lg font-bold italic drop-shadow-md font-heading">Marrakech</div>
            </div>
             ...
             <div className="absolute top-[340px] right-0 w-[160px] h-[240px] rounded-t-full rounded-b-xl overflow-hidden shadow-2xl z-0 transition-transform hover:scale-105 duration-500 delay-100">
              <img src="https://images.unsplash.com/photo-1499856871958-5b9627545d1a?q=80&w=600" alt="Amalfi Coast" className="w-full h-full object-cover" />
              <div className="absolute bottom-3 left-5 text-white text-lg font-bold italic drop-shadow-md font-heading">Amalfi Coast</div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="flex flex-wrap items-center justify-center lg:justify-start gap-8 md:gap-12 opacity-70 hover:opacity-100 transition-opacity duration-300">
             <span className="text-sm font-bold tracking-widest uppercase text-muted-foreground mr-4">Trusted Partners</span>
             <span className="text-xl font-bold font-sans text-blue-600 tracking-tighter">stripe</span>
             <span className="text-xl font-bold font-sans text-orange-600">GetYourGuide</span>
             <span className="text-xl font-bold font-sans text-blue-900 dark:text-blue-300">Booking.com</span>
             <span className="text-xl font-bold font-sans text-orange-500">RVshare</span>
             <span className="text-xl font-bold font-sans text-blue-500">agoda</span>
          </div>
        </motion.div>
      </section>
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <div>
              ...
              <p className="text-muted-foreground text-lg">Handpicked destinations our travelers love</p>
            </div>
            <Button variant="ghost" className="hidden md:flex gap-1" asChild>
              <Link to="/destinations">See All <ArrowRight className="h-4 w-4" /></Link>
            </Button>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {FEATURED_DESTINATIONS.slice(0, 8).map((dest, index) => (
              ...
              >
                <Card className="glass-card group cursor-pointer overflow-hidden h-full flex flex-col" onClick={() => {}}>
                  <div className="relative h-52 overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                      ...
                      <div className="flex items-center gap-1.5 text-white/90 text-sm"><MapPin className="h-3.5 w-3.5" /> {dest.country}</div>
                    </div>
                  </div>
                  <CardContent className="p-4 flex items-center justify-between">
                    <div className="flex items-center gap-1.5 text-xs text-muted-foreground"><Clock className="h-3 w-3" /> {dest.bestSeason}</div>
                    <div className="flex items-center gap-1 text-sm font-bold text-primary"><Wallet className="h-3.5 w-3.5" /> ₹{dest.averageBudget.toLocaleString()}</div>
                  </CardContent>
                </Card>
              </motion.div>
            ))}
          ...
          <div className="mt-8 text-center md:hidden">
            <Button variant="outline" className="rounded-full" asChild>
              <Link to="/destinations">View All Destinations <ArrowRight className="h-4 w-4 ml-2" /></Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-card/50">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <div>
              <h2 className="text-3xl md:text-4xl font-bold mb-2 flex items-center gap-3"><Compass className="h-8 w-8 text-emerald-500" /> Things To Do</h2>
              <p className="text-muted-foreground text-lg">Unforgettable activities curated by locals</p>
            </div>
            <Button variant="ghost" className="hidden md:flex gap-1" asChild>
              <Link to="/things-to-do">See All <ArrowRight className="h-4 w-4" /></Link>
            </Button>
          </motion.div>
              ...
              >
                <Card className="glass-card group cursor-pointer overflow-hidden h-full flex flex-col">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div className="absolute top-3 left-3 bg-emerald-500/90 px-3 py-1 rounded-full text-white text-xs font-bold">{item.category}</div>
                  ...
                  <CardContent className="p-4 flex flex-col flex-1">
                    <h3 className="font-bold text-sm mb-1.5 group-hover:text-emerald-600 transition-colors line-clamp-2">{item.title}</h3>
                    <div className="flex items-center gap-1 text-xs text-muted-foreground mb-1"><MapPin className="h-3 w-3" /> {item.location}</div>
                    <div className="flex items-center gap-3 text-xs text-muted-foreground mb-3"><span className="flex items-center gap-1"><Clock className="h-3 w-3" /> {item.duration}</span></div>
                    <div className="mt-auto flex items-center justify-between">
                      <span className="text-sm font-bold text-foreground">{formatCurrency(item.price)}</span>
                      <Button variant="gradient" size="sm" className="rounded-full text-xs h-8 gap-1 shadow-md">
      ...
      <section className="py-20 bg-card/50">
        <div className="container mx-auto px-4 md:px-6 space-y-16">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold mb-4 flex items-center justify-center gap-3"><TrendingUp className="h-8 w-8 text-primary" /> Trending Destinations</h2>
            <p className="text-muted-foreground text-lg">What's hot right now among travelers</p>
          </motion.div>
                  ...
                  >
                    <Card className="glass-card overflow-hidden group cursor-pointer h-full">
                      <div className="relative h-56 overflow-hidden">
                        <div className="absolute top-3 left-3 z-20 bg-black/50 backdrop-blur-md px-3 py-1 rounded-full text-white text-xs font-medium border border-white/10">{dest.tag}</div>
                        <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent z-10" />
                        <img src={dest.image} alt={dest.name} className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" loading="lazy" />
                        <div className="absolute bottom-0 left-0 right-0 p-5 z-20 text-white">
                          <h4 className="text-xl font-bold mb-1">{dest.name}</h4>
                          <div className="flex items-center gap-3 text-sm text-white/90">
                            <span className="flex items-center gap-1"><MapPin className="h-3.5 w-3.5" /> {dest.country}</span>
                            <span className="flex items-center gap-1"><Star className="h-3.5 w-3.5 fill-amber-400 text-amber-400" /> {dest.rating}</span>
                          </div>
                        </div>
                      </div>
                    </Card>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">Join thousands of happy travelers</p>
          </motion.div>
            ...
            {TESTIMONIALS.map((t, i) => (
              ...
              >
                <Card className="glass-card p-6 h-full flex flex-col">
                  ...
                  <p className="text-sm text-foreground/80 leading-relaxed flex-1 mb-6">"{t.content}"</p>
                  <div className="flex items-center gap-3 mt-auto pt-4 border-t border-border/30">
                    <div className="h-10 w-10 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white font-bold text-sm">{t.name[0]}</div>
                    <div>
