...
export function LiveCursors({ tripId, containerRef }: { tripId: string, containerRef: React.RefObject<HTMLDivElement> }) {
  ...
  useEffect(() => {
    ...
    const unsubscribe = subscribe('cursor_moved', (data: { socketId: string, position: CursorPosition, user: Collaborator }) => {
