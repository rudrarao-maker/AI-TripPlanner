  ...
  return (
    <Card className="glass-card overflow-hidden group border-border/50 h-full flex flex-col">
      ...
      <CardContent className="p-5 flex-1 flex flex-col">
        <div className="mb-2">
          <h3 className="text-xl font-bold line-clamp-1 text-foreground">{hotel.name}</h3>
        ...
        <div className="flex flex-wrap gap-2 mt-4 mb-6">
          {hotel.amenities.slice(0, 3).map((amenity, i) => (
            <span key={i} className="text-xs px-2 py-1 bg-muted rounded-md flex items-center gap-1 text-muted-foreground">
