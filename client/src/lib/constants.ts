...
export const FEATURED_DESTINATIONS: Destination[] = [
  ...
  },
  {
    ...
    name: 'Bali',
    country: 'Indonesia',
    description: 'Tropical paradise with stunning rice terraces, ancient temples, and world-class surf.',
...
export const TRENDING_SECTIONS = [
  {
    ...
    destinations: [
      { name: 'Rishikesh', country: 'India', image: 'https://images.unsplash.com/photo-1600100397608-e4b89b984968?w=600', rating: 4.8, tag: 'Adventure' },
      { name: 'Dubai', country: 'UAE', image: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=600', rating: 4.7, tag: 'Luxury' },
      { name: 'Shimla', country: 'India', image: 'https://images.unsplash.com/photo-1597074866923-dc0589150458?w=600', rating: 4.6, tag: 'Hill Station' },
    ],
  },
  {
    id: 'weekend',
    ...
    destinations: [
      { name: 'Lonavala', country: 'India', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600', rating: 4.4, tag: 'Nature' },
      { name: 'Pondicherry', country: 'India', image: 'https://images.unsplash.com/photo-1582510003544-4d00b7f74220?w=600', rating: 4.6, tag: 'Beach' },
      { name: 'Coorg', country: 'India', image: 'https://images.unsplash.com/photo-1625505826533-5c80aca7d157?w=600', rating: 4.7, tag: 'Nature' },
    ],
  },
  {
    id: 'family',
    ...
    destinations: [
      { name: 'Ooty', country: 'India', image: 'https://images.unsplash.com/photo-1585409677983-0f6c41ca9c3b?w=600', rating: 4.5, tag: 'Hill Station' },
      { name: 'Singapore', country: 'Singapore', image: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=600', rating: 4.8, tag: 'Family' },
      { name: 'Jaisalmer', country: 'India', image: 'https://images.unsplash.com/photo-1477587458883-47145ed94245?w=600', rating: 4.6, tag: 'Culture' },
    ],
  },
  {
    id: 'honeymoon',
    ...
    destinations: [
      { name: 'Maldives', country: 'Maldives', image: 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=600', rating: 4.9, tag: 'Romantic' },
      { name: 'Santorini', country: 'Greece', image: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=600', rating: 4.8, tag: 'Romantic' },
      { name: 'Udaipur', country: 'India', image: 'https://images.unsplash.com/photo-1585128903994-9788298932a4?w=600', rating: 4.7, tag: 'Heritage' },
    ],
  },
  {
    id: 'budget',
    ...
    destinations: [
      { name: 'Varanasi', country: 'India', image: 'https://images.unsplash.com/photo-1561361513-2d000a50f0dc?w=600', rating: 4.5, tag: 'Spiritual' },
      { name: 'Hampi', country: 'India', image: 'https://images.unsplash.com/photo-1590050752117-238cb0fb12b1?w=600', rating: 4.7, tag: 'History' },
      { name: 'Pushkar', country: 'India', image: 'https://images.unsplash.com/photo-1586611292717-f828b167408c?w=600', rating: 4.4, tag: 'Culture' },
    ],
  },
  {
    id: 'hidden',
    title: '💎 Hidden Gems',
    destinations: [
      { name: 'Spiti Valley', country: 'India', image: 'https://images.unsplash.com/photo-1626621341517-bbf3d9990a23?w=600', rating: 4.9, tag: 'Adventure' },
      { name: 'Ziro Valley', country: 'India', image: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=600', rating: 4.6, tag: 'Nature' },
      { name: 'Tirthan Valley', country: 'India', image: 'https://images.unsplash.com/photo-1464822759023-fed622ff2c3b?w=600', rating: 4.8, tag: 'Hidden' },
    ],
  },
];
...
export const GALLERY_IMAGES = [
  { id: 'g1', src: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=800', alt: 'Mountain Landscape', location: 'Swiss Alps', height: 'tall' as const },
  { id: 'g2', src: 'https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=800', alt: 'Tropical Beach', location: 'Maldives', height: 'short' as const },
  { id: 'g3', src: 'https://images.unsplash.com/photo-1502602898657-3e91760cbb34?w=800', alt: 'Eiffel Tower', location: 'Paris', height: 'medium' as const },
  { id: 'g4', src: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=800', alt: 'Bali Temple', location: 'Bali', height: 'tall' as const },
  { id: 'g5', src: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=800', alt: 'Dubai Skyline', location: 'Dubai', height: 'short' as const },
  { id: 'g6', src: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=800', alt: 'Santorini Sunset', location: 'Santorini', height: 'medium' as const },
  { id: 'g7', src: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?w=800', alt: 'Kyoto Temple', location: 'Kyoto', height: 'tall' as const },
  { id: 'g8', src: 'https://images.unsplash.com/photo-1516483638261-f4dafaa48cce?w=800', alt: 'Positano Coast', location: 'Positano', height: 'medium' as const },
  { id: 'g9', src: 'https://images.unsplash.com/photo-1528127269322-539801943592?w=800', alt: 'Halong Bay', location: 'Vietnam', height: 'short' as const },
  { id: 'g10', src: 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=800', alt: 'Overwater Villa', location: 'Maldives', height: 'tall' as const },
  { id: 'g11', src: 'https://images.unsplash.com/photo-1525625293386-3f8f99389edd?w=800', alt: 'Singapore Gardens', location: 'Singapore', height: 'medium' as const },
  { id: 'g12', src: 'https://images.unsplash.com/photo-1602216056096-3b40cc0c9944?w=800', alt: 'Kerala Backwaters', location: 'Kerala', height: 'short' as const },
];
...
export const BLOG_CATEGORIES = [
  { id: 'tips', label: 'Travel Tips', icon: '💡', color: 'bg-amber-500/10 text-amber-600' },
  { id: 'city', label: 'City Guides', icon: '🏙️', color: 'bg-blue-500/10 text-blue-600' },
  { id: 'packing', label: 'Packing Guides', icon: '🎒', color: 'bg-green-500/10 text-green-600' },
  { id: 'budget', label: 'Budget Travel', icon: '💰', color: 'bg-purple-500/10 text-purple-600' },
  { id: 'visa', label: 'Visa Information', icon: '📋', color: 'bg-red-500/10 text-red-600' },
];

export const BLOG_POSTS = [
  { id: 'b1', title: '10 Hidden Gems in Bali You Must Visit', date: 'Jul 15, 2026', category: 'tips', image: 'https://images.unsplash.com/photo-1537996194471-e657df975ab4?w=600', excerpt: 'Discover the untouched beaches and serene temples away from the tourist crowds.', readTime: '5 min', author: 'Priya S.' },
  { id: 'b2', title: 'Complete City Guide to Tokyo', date: 'Jul 10, 2026', category: 'city', image: 'https://images.unsplash.com/photo-1503899036084-c55cdd92da26?w=600', excerpt: 'Everything you need to know before visiting the Japanese capital — from transport to food.', readTime: '12 min', author: 'Rahul M.' },
  { id: 'b3', title: 'How to Pack for a 2-Week Europe Trip', date: 'Jul 5, 2026', category: 'packing', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=600', excerpt: 'Fit everything into a carry-on with our expert packing strategies.', readTime: '7 min', author: 'Ananya R.' },
  { id: 'b4', title: 'Southeast Asia on ₹50,000', date: 'Jun 28, 2026', category: 'budget', image: 'https://images.unsplash.com/photo-1528127269322-539801943592?w=600', excerpt: 'A complete budget breakdown for an unforgettable 10-day trip through Thailand, Vietnam, and Cambodia.', readTime: '10 min', author: 'Arjun K.' },
  { id: 'b5', title: 'Schengen Visa Guide for Indians', date: 'Jun 20, 2026', category: 'visa', image: 'https://images.unsplash.com/photo-1436491865332-7a61a109db05?w=600', excerpt: 'Step-by-step guide to getting your Schengen visa approved on the first attempt.', readTime: '8 min', author: 'Neha T.' },
  { id: 'b6', title: 'Ultimate Street Food Tour of Old Delhi', date: 'Jun 15, 2026', category: 'tips', image: 'https://images.unsplash.com/photo-1567337710282-00832b415979?w=600', excerpt: 'Navigate the narrow lanes for the most authentic chaat, kebabs, and parathas.', readTime: '6 min', author: 'Vikram S.' },
];
